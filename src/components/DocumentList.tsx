  ...
  if (documentList.length === 0) {
    return (
      <div className="px-8 py-16 text-center text-muted-foreground">
        ...
        <div className="mt-6 flex flex-col gap-3 items-center md:flex-row md:items-center md:justify-center">
          <input
            type="file"
            ref={fileInputRef}
        ...
        <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            ...
            <div className="flex flex-row items-center gap-3">
              ...
              <Link
                to="/doc/new"
                className="flex-1 inline-flex items-center justify-center rounded-md px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary-hover hover:text-primary-hover-text bg-primary"
              >
                Create New Document
              </Link>
            </div>
